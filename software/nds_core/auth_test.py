...
def test_encode_password_v1() -> None:
    ...
    assert validate_password_v1(b"testPassword", res) == True
    assert validate_password_v1(b"testPasswor", res) == False
    ...
    assert validate_password_v1(b"iwertoiu", secret) == True
